...
- 5260cbc: Resolve an issue to its fixing release. Paste a GitHub issue URL (`/issues/N`)
...
- 44771dd: Resolve releases whose first containing tag falls outside the fetched tag-list
